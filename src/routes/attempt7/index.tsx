    ...
    <div class="min-h-screen flex flex-col font-mono" style="background: #f0ede8; color: #0a0a0a">
      ...
      <header class="p-5 flex items-center justify-between" style="border-bottom: 4px solid #0a0a0a">
        ...
        <nav class="flex gap-0">
          <A href="/attempt7" class="font-black text-sm uppercase px-4 py-2 tracking-wide" style="background: #0a0a0a; color: #f0ede8">Profile</A>
          <A href="/attempt7/favourites" class="font-black text-sm uppercase px-4 py-2 tracking-wide transition hover:bg-[#0a0a0a] hover:text-[#f0ede8]" style="border: 4px solid #0a0a0a">Favourites</A>
        </nav>
          ...
          {user => (
            <div class="flex flex-col md:flex-row gap-12 items-start">
              ...
              <div>
                ...
                <A href="/attempt7/favourites" class="inline-block font-black text-sm uppercase px-6 py-3 tracking-wide transition hover:bg-[#1DB954] hover:border-[#1DB954] hover:text-black" style="border: 4px solid #0a0a0a">
                  See Top Music →
                </A>
              </div>
            </div>
