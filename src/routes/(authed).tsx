...
import { authStore, setAuthStore } from "~/lib/storage";
...
export default function AuthedLayout(props: {
  ...
  const linkClass = (href: string) =>
    `font-black text-xs sm:text-sm uppercase px-3 sm:px-4 py-2 tracking-wide transition ${isActive(href) ? "bg-[#0a0a0a] text-[#f0ede8]" : "border-4 border-[#0a0a0a] hover:bg-[#0a0a0a] hover:text-[#f0ede8]"}`;
  const logout = () => {
  ...
  onMount(() => {
    ...
    createShortcut(["Alt", "1"], openProfile, {
      preventDefault: false,
      requireReset: true,
    });
    createShortcut(["Control", "1"], openProfile, {
      preventDefault: false,
      requireReset: true,
    });
    createShortcut(["Meta", "1"], openProfile, {
      preventDefault: false,
      requireReset: true,
    });
    ...
    createShortcut(["Alt", "2"], openFavourites, {
      preventDefault: false,
      requireReset: true,
    });
    createShortcut(["Control", "2"], openFavourites, {
      preventDefault: false,
      requireReset: true,
    });
    createShortcut(["Meta", "2"], openFavourites, {
      preventDefault: false,
      requireReset: true,
    });
    ...
    createShortcut(["Alt", "3"], openExport, {
      preventDefault: false,
      requireReset: true,
    });
    createShortcut(["Control", "3"], openExport, {
      preventDefault: false,
      requireReset: true,
    });
    createShortcut(["Meta", "3"], openExport, {
      preventDefault: false,
      requireReset: true,
    });
    ...
    createShortcut(["Alt", "4"], openAccount, {
      preventDefault: false,
      requireReset: true,
    });
    createShortcut(["Control", "4"], openAccount, {
      preventDefault: false,
      requireReset: true,
    });
    createShortcut(["Meta", "4"], openAccount, {
      preventDefault: false,
      requireReset: true,
    });
  });
